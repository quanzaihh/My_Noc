...
// parameter
parameter Noc_Node_Active = {(`Noc_X_Size*`Noc_Y_Size)1'b1}     // 使能哪些节点
parameter Noc_Pass_Node   = {{`Noc_X_Size*`Noc_Y_Size}1'b0}     // 对于不使能的节点，是否连接
parameter Noc_Link_Reg    = 1                                // 对于不使能但连接的节点，是否打拍       
